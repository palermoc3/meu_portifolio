...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference("About.count") do
      post abouts_url, params: { about: { about_text: @about.about_text, store_id: @about.store_id, title: @about.title } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { about_text: @about.about_text, store_id: @about.store_id, title: @about.title } }
