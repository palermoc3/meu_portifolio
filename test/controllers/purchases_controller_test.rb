...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create purchase' do
    assert_difference('Purchase.count') do
      post purchases_url,
           params: { purchase: { closed: @purchase.closed, packageSize: @purchase.packageSize, paid: @purchase.paid,
                                 price: @purchase.price, receive: @purchase.receive, user_id: @purchase.user_id } }
    end
