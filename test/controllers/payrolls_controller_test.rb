...
class PayrollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create payroll' do
    assert_difference('Payroll.count') do
      post payrolls_url,
           params: { payroll: { commission: @payroll.commission, date_of_payroll: @payroll.date_of_payroll,
                                description: @payroll.description, discount: @payroll.discount, employee_id: @payroll.employee_id, salary: @payroll.salary } }
    end
