...
class ItemPurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_purchase" do
    assert_difference("ItemPurchase.count") do
      post item_purchases_url, params: { item_purchase: { product_id: @item_purchase.product_id, purchase_id: @item_purchase.purchase_id, quantity: @item_purchase.quantity, value: @item_purchase.value } }
    end
  ...
  test "should update item_purchase" do
    patch item_purchase_url(@item_purchase), params: { item_purchase: { product_id: @item_purchase.product_id, purchase_id: @item_purchase.purchase_id, quantity: @item_purchase.quantity, value: @item_purchase.value } }
